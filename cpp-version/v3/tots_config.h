...
#define ScoreFunction						(HP + 1) * 25 + (ATK * 5 + YK * 10 + GK * 20 + BK * 30) * 1000 + DEF * 1000 * 10 / 3
...
#define MEMBER_LIST \
	...
	((	(Player)																					(PlayerStat)	(PlayerCombat)					(EquipStat)	)			(u8)				(EquipFlag)		(0)		(IGNORE)			)	\
	((	(Player)																					(PlayerStat)	(PlayerCombat)					(EquipStat)	)			(i16)				(EquipATK)		(0)		(IGNORE)			)	\
	((	(Player)																					(PlayerStat)	(PlayerCombat)					(EquipStat)	)			(i16)				(EquipDEF)		(0)		(IGNORE)			)	\
